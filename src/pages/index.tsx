  ...
  return (
    <Box>
      <Head>
        ...
        <Seo
          title={pt.title}
          metaDescription={pt.description}
          ...
          <Flex flexDir="column" justifyContent="center">
            ...
            <Flex mt="8" w="100%" p="24px" bg="purple.200" borderRadius="lg">
              ...
              <Text fontSize="sm" lineHeight="md">
                ...
                >
                  <strong>{' DOI'}</strong>
                </Tooltip> {pt.content.doiBoxSecondPart}
              </Text>
            </Flex>
            <ToolBox translation={pt.content.toolBox} />
            {Object.keys(searchResponse).length > 0 && standard === "abnt" && (
              <SearchByDoiResultABNT translation={pt.content.ResultContainer} data={searchResponse} />
            )}
